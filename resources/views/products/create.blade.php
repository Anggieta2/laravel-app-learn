                    ...
                    <div class="card-body">
                        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label class="font-weight-bold">CHECKOUT BOOK DATE</label>
                                        <input type="date" class="form-control @error('checkout_book') is-invalid @enderror" name="checkout_book" placeholder="Masukkan Harga Product">
                                    
                                        <!-- error message untuk checkout_book -->
                                        @error('checkout_book')
                                            <div class="alert alert-danger mt-2">
                                                {{ $message }}
                                            </div>
